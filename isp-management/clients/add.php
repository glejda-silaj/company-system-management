...
if(isset($_POST['add_client'])){
    ...
    $query = "INSERT INTO clients(full_name,email,phone,address)
              VALUES('$full_name','$email','$phone','$address')";
    if(mysqli_query($conn, $query)){
        header("Location: list.php?updated=" . time());
        exit();
    } else {
...
<div class="page-wrapper">
    ...
    <div class="page-header">
        ...
        <div class="title-group">
            <h2>Shto Klient</h2>
            <small>Plotëso të dhënat për klientin e ri</small>
        </div>
    </div>
    ...
    <div class="form-card">
        <div class="form-card-header">
            ...
            <span>Informacioni i Klientit</span>
        </div>
          ...
          <form method="POST" action="add.php" autocomplete="off">
                ...
                <div class="field-group">
                    ...
                    <input type="email" name="email"
                           placeholder="p.sh.example@email.com"
                ...
                <div class="field-group">
                    ...
                    <textarea name="address" placeholder="p.sh. Rruga XXXXX, Tiranë"><?php echo isset($_POST['address']) ? htmlspecialchars($_POST['address']) : ''; ?></textarea>
                </div>

                <div class="form-actions">
                    <button type="submit" name="add_client" class="btn-submit">
